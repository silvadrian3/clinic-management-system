            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="doctorfeedback.php"><i class="fa fa-fw fa-edit"></i> Feedbacks & Comments</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        <h3 class="panel-title">Feedbacks & Comments List</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Feedback or Comment" disabled></th>
                                </tr>
                            </thead>
                            
                            <?php 
                            $res=mysqli_query($con,"SELECT * FROM feedbacks
                                                    ORDER BY ID desc");
                                  if (!$res) {
                                    printf("Error: %s\n", mysqli_error($con));
                                    exit();
                                }
                            while ($feedbacks=mysqli_fetch_array($res)) {                                
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $feedbacks['Sender'] . "</td>";
