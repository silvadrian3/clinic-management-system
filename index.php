    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logo.png" height="45px"></a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Scaling & Polishing (Cleaning)</h4>
                            <p> is a procedure that removes dental plaque, tartar and extrinsic stains that are present on the outer surface of the teeth. Scaling and polishing cleans your teeth, preventing and controlling the severity of gum diseases.</p>
                        </div>
                    </div>

                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>3</h4></div>
                        <div class="col-xs-10">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>7</h4></div>
                        <div class="col-xs-10">
                            <h4>Fixed Bridge and Crowns</h4>
                            <p>Description</p>
                        </div>
                    </div>

                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>8</h4></div>
                        <div class="col-xs-10">
                            <h4>Dentures</h4>
                            <p>Description</p>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>9</h4></div>
                        <div class="col-xs-10">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>10</h4></div>
                        <div class="col-xs-10">
                            <h4>Oral Surgery</h4>
                            <p>Description</p>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>11</h4></div>
                        <div class="col-xs-10">
                            <h4>TMJ Problems</h4>
                            <p>Description</p>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"><h4>12</h4></div>
                        <div class="col-xs-10">
                            <h4>Implants</h4>
                            <p>Description</p>
                        </div>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                    <div class="col-xs-10">
                    <form action="patient/sendFeedback.php" method="POST" accept-charset="utf-8" class="form" role="form">
                       <input type="email" name="txtSender" class="form-control input-lg" placeholder="Email Address" required="required" style="font-size: 20px; width: 500px;" />
                        
                       <br>

                       <textarea class="form-control input-lg" name="txtFeedback" placeholder="Write your feedback or comment here..." style="font-size: 20px; width: 500px; height: 300px;"></textarea>

                       <br>

                       <button class="btn btn-lg btn-primary btn-block signup-btn" type="submit" name="btnSendFeedback" id="signup">Send</button>
                   	</form>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© 2018-2019</p>
